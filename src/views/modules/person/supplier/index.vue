<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="联系人电话" align="center" prop="contactTelephone" />
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier } from "@/api/basic/supplier";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除供应商编号为"' + sids + '"的数据项？').then(function() {
        return delSupplier(sids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/supplier/export', {
        ...this.queryParams
