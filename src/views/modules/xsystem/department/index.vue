  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="科室编号" prop="departmentNumber">
        <el-input
          v-model="queryParams.departmentNumber"
          placeholder="请输入科室编号"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['basic:department:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['basic:department:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['basic:department:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['basic:department:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="科室id" align="center" prop="did" />
      <el-table-column label="科室名称" align="center" prop="departmentName" />
      <el-table-column label="科室编号" align="center" prop="departmentNumber" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="科室编号" prop="departmentNumber">
          <el-input v-model="form.departmentNumber" placeholder="请输入科室编号" />
        </el-form-item>
        <el-form-item label="医院id" prop="hid">
...
<script>
import { listDepartment, getDepartment, delDepartment, addDepartment, updateDepartment } from "@/api/basic/department";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getDepartment(did).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除科室编号为"' + dids + '"的数据项？').then(function() {
        return delDepartment(dids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/department/export', {
        ...this.queryParams
